...
export const processSteps = [
  {
    title: "Charlamos sobre tu idea",
    text: "Entiendo tu negocio, qué necesitás resolver y qué objetivo tiene la página."
  },
  {
    title: "Ordenamos la información",
    text: "Definimos secciones, productos, servicios, datos importantes y flujo del usuario."
  },
  {
    title: "Diseño la experiencia",
    text: "Armo una propuesta visual clara, responsive y alineada a la identidad del proyecto."
  },
  {
    title: "Desarrollo la solución",
    text: "Construyo la web o herramienta con foco en funcionalidad, velocidad y facilidad de uso."
  },
  {
    title: "Probamos todo",
    text: "Reviso navegación, formularios, botones, WhatsApp, mobile y detalles importantes."
  },
  {
    title: "Te explico cómo usarla",
    text: "Dejo todo listo y te explico cómo administrar lo que necesites modificar."
  }
];
